...
(function() {
  ...
  var Ba = { ld: { Ta: "https://staging-identitytoolkit.sandbox.googleapis.com/identitytoolkit/v3/relyingparty/", Za: "https://staging-securetoken.sandbox.googleapis.com/v1/token", Wa: "https://staging-identitytoolkit.sandbox.googleapis.com/v2/", id: "b" }, sd: { Ta: "https://www.googleapis.com/identitytoolkit/v3/relyingparty/", Za: "https://securetoken.googleapis.com/v1/token", Wa: "https://identitytoolkit.googleapis.com/v2/", id: "p" }, ud: {
  ...
  function Ca(a) {
    for (var b in Ba)
      if (Ba[b].id === a)
        return a = Ba[b], { firebaseEndpoint: a.Ta, secureTokenEndpoint: a.Za, identityPlatformEndpoint: a.Wa };
    return null;
  }
  var Da;
    ...
    return new D(function(b) {
      ...
      if (c)
        for (var e = function(h, m, p) {
          c--;
          d[h] = m ? { Pb: true, value: p } : { Pb: false, reason: p };
          c == 0 && b(d);
        }, f = 0, g; f < a.length; f++)
  ...
  var Vc = 0, Wc = {};
  Uc.prototype.xa = false;
  function Xc(a) {
    if (!a.xa && (a.xa = true, a.Da(), Vc != 0)) {
      var b = pa(a);
  ...
  hd.prototype.add = function(a, b, c, d, e) {
    ...
    a || (a = this.a[f] = [], this.b++);
    var g = id(a, b, d, e);
    -1 < g ? (b = a[g], c || (b.Pa = false)) : (b = new fd(b, this.src, f, !!d, e), b.Pa = c, a.push(b));
    return b;
  };
  function jd(a, b) {
    var c = b.type;
    ...
    if (a = sd(a)) {
      if (b = a.a[b.toString()])
        for (b = b.concat(), a = 0; a < b.length; a++) {
          var f = b[a];
          f && f.capture == c && !f.va && (f = Bd(f, d), e = e && f !== false);
        }
    }
    return e;
  }
    ...
    if (!Zc) {
      ...
      if (!(0 > d.keyCode || d.returnValue != void 0)) {
        ...
        for (e = d.length - 1; 0 <= e; e--) {
          b.b = d[e];
          var f = Ad(d[e], a, true, b);
          c = c && f;
        }
        for (e = 0; e < d.length; e++)
          b.b = d[e], f = Ad(d[e], a, false, b), c = c && f;
      }
      return c;
    }
  ...
  function ei(a, b, c, d, e) {
    ...
    try {
      Uh(a.b, fi(a, "Opening Xhr")), a.O = true, a.a.open(c, String(b), true), a.O = false;
    } catch (g) {
  ...
  var zi = {};
  function Bi(a) {
    var b = {}, c = b.document || document, d = yb(a).toString(), e = oc(document, "SCRIPT"), f = { Wb: e, Ma: void 0 }, g = new pi(f), h = null, m = b.timeout != null ? b.timeout : 5e3;
  ...
  var Dj = { endpoint: "setAccountInfo", A: Aj, Z: "email", B: true }, Cj = { endpoint: "resetPassword", A: Aj, G: function(a) {
  ...
  }, G: P, V: true, B: true }, bj = { endpoint: "createAuthUri", B: true }, Fj = { endpoint: "deleteAccount", N: ["idToken"] }, sj = { endpoint: "setAccountInfo", N: ["idToken", "deleteProvider"], A: function(a) {
    if (!Array.isArray(a.deleteProvider))
      throw new t("internal-error");
  } }, $g = { endpoint: "emailLinkSignin", N: ["email", "oobCode"], A: Zi, G: P, V: true, B: true }, bh = { endpoint: "emailLinkSignin", N: ["idToken", "email", "oobCode"], A: Zi, G: P, V: true }, Gj = { endpoint: "accounts/mfaEnrollment:finalize", N: ["idToken", "phoneVerificationInfo"], A: pj, G: P, B: true, Na: true }, Hj = { endpoint: "accounts/mfaSignIn:finalize", N: ["mfaPendingCredential", "phoneVerificationInfo"], A: pj, G: P, B: true, Na: true }, Ij = { endpoint: "getAccountInfo" }, jj = { endpoint: "getOobConfirmationCode", N: ["requestType"], A: function(a) {
    ...
    if (!a.recaptchaSiteKey)
      throw new t("internal-error");
  } }, Bj = { endpoint: "resetPassword", A: Aj, Z: "email", B: true }, mj = { endpoint: "sendVerificationCode", N: ["phoneNumber", "recaptchaToken"], Z: "sessionInfo", B: true }, gj = { endpoint: "setAccountInfo", N: ["idToken"], A: $i, V: true }, ch = {
    ...
    G: P,
    V: true
  }, fj = { endpoint: "signupNewUser", G: P, V: true, B: true }, oj = { endpoint: "accounts/mfaEnrollment:start", N: ["idToken", "phoneEnrollmentInfo"], A: function(a) {
  ...
  }, jh = { Hb: { USER_NOT_FOUND: "user-not-found" }, endpoint: "verifyPhoneNumber", A: ej, G: P, B: true }, Lj = { endpoint: "accounts/mfaEnrollment:withdraw", N: ["idToken", "mfaEnrollmentId"], G: function(a) {
  ...
  function O(a, b, c) {
    ...
    return E(c).then(b.A).then(function() {
      ...
      return d ? Yi(a, a.i, b.endpoint, e, c, b.Hb, b.lb || false) : Yi(a, a.h, b.endpoint, e, c, b.Hb, b.lb || false);
    }).then(function(g) {
      f = g;
  ...
  Wj.prototype.toString = function() {
    ...
    typeof this.a.Qb === "function" && (c = this.a.Qb(), c.length && I(a, "scopes", c.join(",")));
  ...
  gk.prototype.c = function(a) {
    ...
    if (d && 0 < d.length) {
      ...
      Jc(e).then(function(f) {
        var g = [];
        w(f, function(h) {
          g.push({ fulfilled: h.Pb, value: h.value, reason: h.reason ? h.reason.message : void 0 });
        });
        w(g, function(h) {
          for (var m in h)
  ...
  function $k(a) {
    ...
    a.c = setInterval(function() {
      for (var b in a.a) {
        ...
        c != d && (a.b[b] = c, c = new bd({ type: "storage", key: b, target: window, oldValue: d, newValue: c, a: true }), a.Yb(c));
      }
    }, 1e3);
  }
  function al(a) {
  ...
  function Mm(a, b) {
    a.$ = b;
    Ri(a.a, index_esm_default.SDK_VERSION ? Oe(index_esm_default.SDK_VERSION, a.$) : null);
  }
  ...
  k.Fa = function(a, b) {
    return a == "linkViaPopup" && b == (this.g || null) ? q(this.Kb, this) : a == "reauthViaPopup" && b == (this.g || null) ? q(this.Lb, this) : a == "linkViaRedirect" && (this.ga || null) == b ? q(this.Kb, this) : a == "reauthViaRedirect" && (this.ga || null) == b ? q(this.Lb, this) : null;
  };
  k.Ec = function(a) {
    var b = this;
  ...
  function jn(a, b, c, d, e) {
    ...
    (!Te() || Ie()) && a.s && c.isOAuthProvider && (h = ek(a.s, a.l, a.m, b, c, null, g, index_esm_default.SDK_VERSION || null, null, null, a.tenantId));
  ...
  function R(a, b, c) {
    ...
    return d.o(function(e) {
      var f = null;
      e && e.code === "auth/multi-factor-auth-required" && (f = mm(e.w(), Qm(a), q(a.jc, a)));
      throw f || e;
    });
  }
  k.jc = function(a) {
  ...
  var mn = { name: "redirectUser", F: "session" };
  function nn(a) {
  ...
  un.prototype.g = function() {
    ...
    xn(this, function() {
      return E().then(function() {
        ...
        if (c)
          return yn(a, "local").then(function() {
            a.c = b;
          });
      });
    });
  ...
  var zn = { name: "persistence", F: "session" };
  function wn(a) {
  ...
  function En(a) {
    ...
    this.s = [];
    this.O = [];
    this.hb = index_esm_default.INTERNAL.createSubscribe(q(this.zc, this));
    this.X = void 0;
    this.bc = index_esm_default.INTERNAL.createSubscribe(q(this.Ac, this));
    Fn(this, null);
  ...
  k.Xc = function(a) {
    ...
    (!Te() || Ie()) && S(this).options.authDomain && a.isOAuthProvider && (e = ek(S(this).options.authDomain, S(this).options.apiKey, S(this).name, "signInViaPopup", a, null, d, index_esm_default.SDK_VERSION || null, null, null, this.T(), this.P));
  ...
  function Gn(a) {
    var b = S(a).options.authDomain, c = Tn(a).then(function() {
      ...
      return d ? (d.ha = a.D, a.m && (a.m.ga || null) == (d.ga || null) ? d : d.reload().then(function() {
        ...
        return e.code == "auth/network-request-failed" ? d : Cn(a.i);
      })) : null;
    }).then(function(d) {
      Fn(a, d || null);
    });
  ...
  k.Zc = function() {
    ...
    return Dn(this.i, S(this).options.authDomain).then(function(b) {
      if (!a.l) {
        ...
        if (U(a) || b)
          Fn(a, b), b && (Vm(b), b.ha = a.D), a.b && Pl(a.b, a), Rn(a);
      }
    });
  };
  k.da = function(a) {
  ...
  k.Tc = function(a) {
    var b = this;
    return this.h.then(function() {
      return Pn(b, O(b.a, Kj, { token: a }));
    }).then(function(c) {
      var d = c.user;
      an(d, "isAnonymous", false);
      b.da(d);
      return c;
    });
  };
  k.Uc = function(a, b) {
    var c = this;
    return this.h.then(function() {
      return Pn(c, O(c.a, ah, { email: a, password: b }));
    });
  };
  k.dc = function(a, b) {
    var c = this;
    return this.h.then(function() {
      return Pn(c, O(c.a, Ej, { email: a, password: b }));
    });
  };
  k.$a = function(a) {
    var b = this;
  ...
  ;
  Y(En.prototype, {
    jb: { name: "applyActionCode", j: [V("code")] },
    Ra: { name: "checkActionCode", j: [V("code")] },
    nb: { name: "confirmPasswordReset", j: [V("code"), V("newPassword")] },
    ...
    Hc: { name: "onAuthStateChanged", j: [X(W(), xo(), "nextOrObserver"), xo("opt_error", true), xo("opt_completed", true)] },
    Ic: {
      name: "onIdTokenChanged",
      j: [X(W(), xo(), "nextOrObserver"), xo("opt_error", true), xo("opt_completed", true)]
    },
    vb: { name: "sendPasswordResetEmail", j: [V("email"), X(W("opt_actionCodeSettings", true), yo(null, true), "opt_actionCodeSettings", true)] },
    wb: { name: "sendSignInLinkToEmail", j: [V("email"), W("actionCodeSettings")] },
    xb: { name: "setPersistence", j: [V("persistence")] },
    Sc: { name: "signInAndRetrieveDataWithCredential", j: [Co()] },
    zb: { name: "signInAnonymously", j: [] },
    $a: { name: "signInWithCredential", j: [Co()] },
    ...
    Wc: { name: "signInWithPhoneNumber", j: [V("phoneNumber"), Ho()] },
    Xc: { name: "signInWithPopup", j: [Eo()] },
    Yc: { name: "signInWithRedirect", j: [Eo()] },
  ...
  Jo(En.prototype, { lc: { name: "languageCode", kb: X(V(), yo(), "languageCode") }, ti: { name: "tenantId", kb: X(V(), yo(), "tenantId") } });
  En.Persistence = Rk;
  ...
  Y(Im.prototype, {
    ...
    oc: { name: "getIdTokenResult", j: [wo("opt_forceRefresh", true)] },
    I: { name: "getIdToken", j: [wo("opt_forceRefresh", true)] },
    Cc: { name: "linkAndRetrieveDataWithCredential", j: [Co()] },
    qb: { name: "linkWithCredential", j: [Co()] },
    Dc: { name: "linkWithPhoneNumber", j: [V("phoneNumber"), Ho()] },
    Ec: { name: "linkWithPopup", j: [Eo()] },
    Fc: { name: "linkWithRedirect", j: [Eo()] },
    Lc: { name: "reauthenticateAndRetrieveDataWithCredential", j: [Co()] },
    tb: { name: "reauthenticateWithCredential", j: [Co()] },
    Mc: {
      name: "reauthenticateWithPhoneNumber",
      j: [V("phoneNumber"), Ho()]
    },
    Nc: { name: "reauthenticateWithPopup", j: [Eo()] },
    Oc: { name: "reauthenticateWithRedirect", j: [Eo()] },
    reload: { name: "reload", j: [] },
    ub: { name: "sendEmailVerification", j: [X(W("opt_actionCodeSettings", true), yo(null, true), "opt_actionCodeSettings", true)] },
    toJSON: { name: "toJSON", j: [V(null, true)] },
    cd: { name: "unlink", j: [V("provider")] },
    Bb: { name: "updateEmail", j: [V("email")] },
    Cb: { name: "updatePassword", j: [V("password")] },
    ed: { name: "updatePhoneNumber", j: [Co("phone")] },
    Db: { name: "updateProfile", j: [W("profile")] },
    Eb: { name: "verifyBeforeUpdateEmail", j: [V("email"), X(W("opt_actionCodeSettings", true), yo(null, true), "opt_actionCodeSettings", true)] }
  });
  ...
  Z(Ug, "credential", Vg, [X(V(), X(W(), yo()), "idToken"), X(V(), yo(), "accessToken", true)]);
  Y(Wg.prototype, { Ka: { name: "setCustomParameters", j: [W("customOAuthParameters")] } });
  Z(Wg, "credential", Xg, [X(V(), W(), "token"), V("secret", true)]);
  Y(Pg.prototype, { Ca: { name: "addScope", j: [V("scope")] }, credential: { name: "credential", j: [X(V(), X(W(), yo()), "optionsOrIdToken"), X(V(), yo(), "accessToken", true)] }, Ka: { name: "setCustomParameters", j: [W("customOAuthParameters")] } });
  ...
  Y(lh.prototype, { fb: { name: "verifyPhoneNumber", j: [X(V(), function(a, b) {
    return { name: a || "phoneInfoOptions", K: "valid phone info options", optional: !!b, M: function(c) {
      return c ? c.session && c.phoneNumber ? Fo(c.session, zg) && typeof c.phoneNumber === "string" : c.session && c.multiFactorHint ? Fo(c.session, Ag) && Go(c.multiFactorHint) : c.session && c.multiFactorUid ? Fo(c.session, Ag) && typeof c.multiFactorUid === "string" : c.phoneNumber ? typeof c.phoneNumber === "string" : false : false;
    } };
  }(), "phoneInfoOptions"), Ho()] } });
  ...
  Y(im.prototype, { Rc: { name: "resolveSignIn", j: [Do()] } });
  Y(tm.prototype, { Rb: { name: "getSession", j: [] }, fc: { name: "enroll", j: [Do(), V("displayName", true)] }, bd: { name: "unenroll", j: [X({ name: "multiFactorInfo", K: "a valid multiFactorInfo", optional: false, M: Go }, V(), "multiFactorInfoIdentifier")] } });
  ...
  (function() {
    if (typeof index_esm_default !== "undefined" && index_esm_default.INTERNAL && index_esm_default.INTERNAL.registerComponent) {
      ...
      Z(a, "RecaptchaVerifier", to, [X(V(), zo(), "recaptchaContainer"), W("recaptchaParameters", true), Bo()]);
      ...
      index_esm_default.registerVersion("@firebase/auth", "0.16.6");
