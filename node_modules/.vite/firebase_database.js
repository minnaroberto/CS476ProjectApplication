...
function repoGetValue(repo, query2) {
  ...
  return repo.server_.get(query2).then(function(payload) {
    var node = nodeFromJSON$1(payload).withIndex(query2._queryParams.getIndex());
...
var FirebaseDatabase = function() {
  function FirebaseDatabase2(_repoInternal, app) {
    this._repoInternal = _repoInternal;
    this.app = app;
    this["type"] = "database";
    this._instanceStarted = false;
  }
  Object.defineProperty(FirebaseDatabase2.prototype, "_repo", {
    get: function() {
  ...
  Object.defineProperty(FirebaseDatabase2.prototype, "_root", {
    get: function() {
  ...
  FirebaseDatabase2.prototype._delete = function() {
  ...
  FirebaseDatabase2.prototype._checkNotDeleted = function(apiName) {
